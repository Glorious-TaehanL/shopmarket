...
export function EditForm({data}: iAppProps) {
    ...
    return(
        ...
        <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl font-semibold tracking-tight">상품 수정하기</h1>
        </div>
        ...
        <Card className="mt-5">
            ...
            <CardContent>
                <div className="flex flex-col gap-6">
                    ...
                    <div className="flex flex-col gap-3">
                        <Label>Price</Label>
                        <Input key={fields.price.key} name={fields.price.name} defaultValue={data.price} type="number" placeholder="₩150,000" />
                    ...
                    <div className="flex flex-col gap-3">
                        <Label>Images</Label>
                        <input type="hidden" value={images} key={fields.images.key} name={fields.images.name} defaultValue={fields.images.initialValue as any}></input>
                       {images.length > 0 ? (
                            <div className="flex gap-5">
                                {images.map((image,index) => (
                                    <div key={index} className="relative w-[100px] h-[100px]">
                                        ...
                                        <button onClick={() => handleDelete(index)} className="absolute -top-3 -right-3 bg-red-500 p-2 rounded-lg text-white">
